namespace AccountingOfSalariesAndPersonnel
{
    partial class О_программе
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBoxDescription.Text = "Разработка базы данных для предметной области \"Учёта зарплаты и кадров\" и приложе" +
    "ния для ведения базы данных";
            // 
            // labelCompanyName
            // 
            ...
            this.labelCompanyName.Text = "Название организации: ИС-201";
            ...
            this.labelCopyright.Text = "Авторские права:     Глеб Алексеевич Фокин";
            ...
            this.labelProductName.Text = "Название продукта:   АИС \"Учёт зарплат и кадров\"";
